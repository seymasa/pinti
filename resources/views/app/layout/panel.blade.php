...
@section('body')
    ...
    <div class="navbar navbar-inverse">
        <div class="navbar-header">
            <a class="navbar-brand" href="{{ route('app.dashboard.index') }}">
                <img src="{{ asset('assets/images/logo_light.png') }}" alt="{{ config('app.name') }}">
            </a>
        ...
        <div class="navbar-collapse collapse" id="navbar-mobile">
            ...
            <p class="navbar-text"><span class="label bg-success">{{ trans('panel.online') }}</span></p>

            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown language-switch">
                    <a class="dropdown-toggle" data-toggle="dropdown">
                        <img src="assets/images/flags/gb.png" class="position-left" alt="">
                        {{ app()->getLocale() == "en" ? "English" : "Türkçe" }}
                        <span class="caret"></span>
                    </a>

                    <ul class="dropdown-menu">
                        <li><a class="english"><img src="assets/images/flags/gb.png" alt=""> English</a></li>
                        <li><a class="espana"><img src="assets/images/flags/es.png" alt=""> Türkçe</a></li>
                    </ul>
                </li>
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a href="{{ route('app.profile.me') }}"><i class="icon-user-plus"></i> {{ trans('panel.my-profile') }}</a></li>
                        <li class="divider"></li>
                        <li><a href="{{ route('app.auth.settings') }}"><i class="icon-cog5"></i> {{ trans('panel.account-settings') }}</a></li>
                        <li><a href="{{ route('app.auth.logout') }}"><i class="icon-switch2"></i> {{ trans('panel.logout') }}</a></li>
                    </ul>
                </li>
            </ul>
        </div>
